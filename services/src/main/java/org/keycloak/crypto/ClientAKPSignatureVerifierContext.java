...
/**
 * Client-side signature verifier context for AKP (Asymmetric Key Pair) algorithms
 * used in PQC, such as ML-DSA (CRYSTALS-Dilithium).
 */
public class ClientAKPSignatureVerifierContext extends AsymmetricSignatureVerifierContext {

    public ClientAKPSignatureVerifierContext(KeycloakSession session, ClientModel client, JWSInput input) throws VerificationException {
